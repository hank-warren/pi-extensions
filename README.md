...
| [`@hank-warren/pi-ask-user-question`](packages/pi-ask-user-question) | Whole question rounds with choices, native text, inline notes, multi-select and optional review-before-submit; stripped from headless subagent runs |
